...
function edite_cliente($id)
{
    ...
    if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        <label for="usuario">Conexões</label>
        <input type="text" class="form-control" name="conexoes" value="'.$conexoes.'">
    </div>';
        $modal_body .= '<div class="form-group col-md col">
        ...
        $modal_body .= '<div class="form-group">
            ...
            <select class="form-control form-select" id="pacote" name="pacote">
...
function adicionar_clientes()
{
    ...
    if ($row = $stmt->fetch()) {
        ...
        $modal_body .= '<div class="form-row row">';
            ...
            $modal_body .= ' <div class="form-group col-md col">
                            <label for="senha">Conexões</label>
                            <input type="text" class="form-control" name="conexoes" value="1" autocomplete="off">
                            </div>';
        $modal_body .= '</div>';
        ...
        $modal_body .= '<div class="form-group">
                        <label for="pacote">Pacote:</label>
                        <select class="form-control form-select" id="pacote" name="pacote">
                        <option value="">Nenhum (usará categorias padrão)</option>
                        </select>';
        $modal_body .= '</div>';
