...
<head>
    ...
    <style>
        ...
        * {
        ...
        .modal-content {
            background-color: #2c3e50 !important; /* Azul escuro mais claro */
        ...
        .modal-header {
            background-color: #1abc9c !important; /* Azul claro como na imagem */
        ...
        .modal-body {
            background-color: #34495e !important; /* Cinza azulado */
            padding: 1.5rem;
            color: #ffffff !important;
            max-height: 421px;
            overflow-y: auto;
        ...
        .modal-body .form-select {
            background-color: #4a5f7a !important; /* Azul acinzentado mais claro */
    ...
    <div class="content-container">
        <div class="page-header">
            <div>
                ...
                <p class="page-subtitle">Gerencie todas as séries do sistema</p>
            </div>
            ...
            <button type="button" class="btn-add" onclick='modal_master("api/series.php", "adicionar_series", "add")'>
...
document.addEventListener('DOMContentLoaded', function() {
    // Wait for datatableseries.js to fully load and initialize
    setTimeout(function() {
    ...
    function enhanceTableVisuals() {
        ...
        $('#data_table tbody td:nth-child(5)').each(function() {
            ...
            if (!$(this).find('.badge').length) {
                if (text.includes('series') || text.includes('série')) {
                    $(this).html('<span class="badge badge-series">SÉRIE</span>');
                } else if (text.includes('season') || text.includes('temporada')) {
                    $(this).html('<span class="badge badge-season">TEMPORADA</span>');
                } else if (text.includes('episode') || text.includes('episódio')) {
                    $(this).html('<span class="badge badge-episode">EPISÓDIO</span>');
        ...
        $('#data_table tbody td:nth-child(3)').each(function() {
            ...
            if (imgSrc && !$cell.find('.series-icon').length) {
                $cell.html(`<img src="${imgSrc}" alt="Icon" class="series-icon">`);
            }
        });
    ...
    console.log('🎯 Séries - Estrutura padrão aplicada!');
});
</script>
